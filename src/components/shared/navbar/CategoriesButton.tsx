...
const CategoriesButton = (props: IProps) => {
  ...
  return (
    <DropdownMenu modal={false}>
      ...
      <DropdownMenuContent className="scrollbar-thumb-rounded-full scrollbar-corner-rounded-full scrollbar-track-rounded-full scrollbar scrollbar-w-1 scrollbar-thumb-slate-700 scrollbar-track-slate-200 z-[1000001] max-h-48 overflow-x-hidden overflow-y-scroll">

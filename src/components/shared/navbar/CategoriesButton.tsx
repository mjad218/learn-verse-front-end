...
const CategoriesButton = (props: IProps) => {
  ...
  return (
    <DropdownMenu modal={false}>
      ...
      <DropdownMenuContent className="scrollbar-thumb-rounded-full scrollbar-track-rounded-full scrollbar scrollbar-w-2 scrollbar-thumb-accent3 scrollbar-track-slate-300 z-[1000001] max-h-48 overflow-x-hidden overflow-y-scroll">
